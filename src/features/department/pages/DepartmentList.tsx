...
export default function DepartmentList() {
    ...
    // ── Table instance ──────────────────────────────────────
    // pageCount is set so TanStack Table enables/disables nav buttons correctly:
    //   - hasNextPage=true  → pageCount = pageIndex + 2 (next button enabled)
    //   - hasNextPage=false → pageCount = pageIndex + 1 (next button disabled)
