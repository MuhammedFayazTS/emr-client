...
export default function AppointmentList() {
    ...
    const { mutate: arriveAppointment, isPending: isArriving, variables: arriveId } = useArriveAppointment();
    const { mutate: completeAppointment, isPending: isCompleting, variables: completeId } = useCompleteAppointment();
    const { mutate: cancelAppointment, isPending: isCancelling, variables: cancelVars } = useCancelAppointment();
    ...
    const pendingAction = useMemo(() => {
        ...
        if (isCancelling && cancelVars?.id) return { id: cancelVars.id, type: 'cancel' as WorkflowAction };
        return undefined;
    ...
    const viewFields: ViewDetailField[] = useMemo(() => {
        ...
        return [
            ...
            { label: 'Time', value: formatAppointmentTime(viewAppointment.startTime, viewAppointment.endTime) },
    ...
    const handleArrive = useCallback((appointment: Appointment) => {
    ...
    const handleCancelConfirm = useCallback((values: CancelAppointmentInput) => {
