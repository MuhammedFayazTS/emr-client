...
export default function ReceptionistForm() {
    ...
    const { mutate: createReceptionist, isPending: isCreatePending, error: createError } = useCreateReceptionist();
    const { mutate: updateReceptionist, isPending: isUpdatePending, error: updateError } = useUpdateReceptionist();

    const { data: receptionistData, isLoading: isReceptionistLoading } = useGetReceptionist(id as string);
    ...
    const onSubmit = (values: CreateReceptionistInput) => {
        ...
        if (isEdit) {
            updateReceptionist({ id: id as string, payload }, {
            ...
            <FieldGroup>
                {error && (
                    <Alert variant="destructive">
                        {error.message || "Failed to save receptionist"}
                    </Alert>
                )}
